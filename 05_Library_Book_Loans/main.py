...
class LibraryMember:
    ...
    def borrow_book(self, book):
        # TODO 2: If can_borrow() is False, return False without changing the list.
...
def main():
    print("=== Library Book Loans ===")
    print("Help the school library prepare for reading week.")
    print("Complete TODOs 1-6 in this file:")
    print("1. Check the borrowing limit.  2. Borrow a book.  3. Return a book.")
    print("4. Initialize a student.  5. Apply the student rule.  6. Sum pages.")
    print("Optional: count books by category.")
